...
int add_water(struct particle* p, struct particle** nlist_array, struct point Po, struct point Pi){
	...
	int num_of_shells = (int) (Po.rad - Pi.rad)/vars.H2O_dia + 1 + vars.luman_safe_depth; /*may need to put a check in here to make sure it doesnt go past the centre point*/
