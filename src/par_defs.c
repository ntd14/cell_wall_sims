...
part_defs FA1 = {"FA1", 3.22625, 1500.0, 0, 0, 0, 0, 100, 3}; /* aprox 35% */
...
part_defs HC1 = {"HC1", 3.22625, 1500.0, M_PI/2, M_PI/2, 0, 0, 0, 0};/* aprox 20% */
part_defs HC2 = {"HC2", 2.0,     1500.0, 0,      0,      0, 0, 8}; /* see FA2 comment */
part_defs H2O = {"H2O", 10.0, 1000.0, 0, 0, 0, 0, 0, 0}; /* aprox 30%, leave number of particles unknown it is calculated later */
