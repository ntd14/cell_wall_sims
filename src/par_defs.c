...
part_defs FA1 = {"FA1", 3.22625, 1500.0, 0, 0, 0.1, 0.02, 100, 1}; /* aprox 35% */ /* Name, Rad, density, MFA, angle in depth, sd on MFA, sd on depth angle, 0.5*max chain length, num of chains */
...
part_defs HC1 = {"HC1", 3.22625, 1500.0, M_PI/2, 0, 0, 0, 5, 3};/* aprox 20% */
part_defs HC2 = {"HC2", 2.0,     1500.0, M_PI/2, 0, 0, 0,  8}; /* see FA2 comment */

part_defs H2O = {"H2O", 4000.0, 1000.0, 0, 0, 0, 0, 0, 0}; /* aprox 30%, leave number of particles unknown it is calculated later */
