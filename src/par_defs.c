...
part_defs FA1 = {"FA1", 3.22625, 1500.0, M_PI/2, M_PI/2, 0, 0, 100, 10}; /* aprox 35% */
part_defs FA2 = {"FA2", 2.0, 1500.0, 0, 0, 0, 0, 0, 0}; /* Note these chains run around the FA1 core use r = Rsin(π/n)/[1 - sin(π/n)] and R = r[1 - sin(π/n)]/sin(π/n)
